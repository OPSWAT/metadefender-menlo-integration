...
function build_image() {
  cd $CWD/../
  docker build -t ${AWS_ACCOUNT}.dkr.ecr.${AWS_REGION}.amazonaws.com/mdcl-menlo:${MENLO-ENV}-$VERSION .
}
...
function push_image() {
  docker push ${AWS_ACCOUNT}.dkr.ecr.${AWS_REGION}.amazonaws.com/mdcl-menlo:${MENLO-ENV}-$VERSION
}
